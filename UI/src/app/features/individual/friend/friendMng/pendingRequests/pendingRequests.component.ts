...
import {acceptFriendShipReq, getPendingRequests} from "../../../../../ngrx/actions/friends/friends.actions";
                        ...
                        <div *ngIf="pendingRequests.length" class="">
	                        <div *ngFor="let request of pendingRequests" class="flex items-center justify-between gap-2 border-b-1 pb-1">
                                ...
                                <div class="flex gap-2">
	                                ...
	                                <!--ignore request-->
                                    <fa-icon [icon]="faCancel" class="text-2xl text-red-500 cursor-pointer" (click)="ignoreRequest(request.id)"></fa-icon>
                                </div>
	                        </div>
                        </div>
